...
|-----|--------------|-------|
| [`kie/`](kie/) — `npm i -g @julio-daza/kie` | Image & video generation on [KIE.ai](https://kie.ai) with hard spend guards, Keychain-stored key, no callbacks to third parties | [`kie/skill/kie-media`](kie/skill/kie-media/SKILL.md) |
